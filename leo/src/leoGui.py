...
#@+node:ekr.20070627082044.806:@test ctors for all dialogs
...
#@+node:ekr.20070627082044.824:@test w.toGui/PythonIndex
if g.unitTesting:
    ...
    for i in xrange(len(s)):
        ...
        assert(i3==i)
#@-node:ekr.20070627082044.824:@test w.toGui/PythonIndex
#@+node:ekr.20070627082044.825:@test w.toGuiIndex (test2)
#ab
#
if g.unitTesting:
...
#@nonl
#@-node:ekr.20070627082044.825:@test w.toGuiIndex (test2)
#@+node:ekr.20070627082044.826:@test leoTextWidget
if g.unitTesting:
    if g.app.gui.guiName() == 'tkinter':
        import Tkinter as Tk
        import leoTkinterFrame
        w = leoTkinterFrame.leoTkTextWidget()
        w.setAllText('abcdef\n')
        s = w.getAllText()
        assert s == 'abcdef\n'
        s1 = w.get(0,len(s))
        ...
        assert aTuple == (4,6),'tag_add failed'
#@-node:ekr.20070627082044.826:@test leoTextWidget
#@-node:ekr.20070627082044.823:g.app.gui & leoTextWidget
#@-node:ekr.20070629065104:Unit tests
#@-others
