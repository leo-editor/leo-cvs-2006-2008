...
#@+others
#@+node:ekr.20070213170721:class baseTextWidget
class baseTextWidget:

    '''The base class for all wrapper classes for the Tk.Text widget.'''
        
    #@    @+others
    #@+node:ekr.20070213170721.1:Birth & special methods (baseText)
    ...
    def GetName(self):
        return self.name
    #@-node:ekr.20070213170721.1:Birth & special methods (baseText)
    #@+node:ekr.20070213170721.2:Do-nothing
    def update (self,*args,**keys):             pass
    def update_idletasks (self,*args,**keys):   pass
    #@-node:ekr.20070213170721.2:Do-nothing
    #@+node:ekr.20070213170721.3:bindings (must be overridden in subclasses)
    ...
    #@nonl
    #@-node:ekr.20070213170721.3:bindings (must be overridden in subclasses)
    #@+node:ekr.20070213170721.4:oops
    def oops (self):
    
        print('wxGui baseTextWidget oops:',self,g.callers(),
            'must be overridden in subclass')
    #@-node:ekr.20070213170721.4:oops
    #@+node:ekr.20070213170721.5:Index conversion
    #@+node:ekr.20070213170721.6:w.toGuiIndex & toPythonIndex
    ...
    #@nonl
    #@-node:ekr.20070213170721.6:w.toGuiIndex & toPythonIndex
    #@+node:ekr.20070213170721.7:w.rowColToGuiIndex
    ...
    #@-node:ekr.20070213170721.7:w.rowColToGuiIndex
    #@-node:ekr.20070213170721.5:Index conversion
    #@+node:ekr.20070213170721.8:Wrapper methods (widget-independent)
    # These methods are widget-independent because they call the corresponding _xxx methods.
    #@nonl
    #@+node:ekr.20070213170721.9:appendText
    def appendText (self,s):
        
        w = self
        w._appendText(s)
    #@-node:ekr.20070213170721.9:appendText
    #@+node:ekr.20070213170721.10:bind
    ...
    #@nonl
    #@-node:ekr.20070213170721.10:bind
    #@+node:ekr.20070213170721.11:clipboard_clear & clipboard_append
    ...
    #@-node:ekr.20070213170721.11:clipboard_clear & clipboard_append
    #@+node:ekr.20070213170721.12:delete
    ...
    #@nonl
    #@-node:ekr.20070213170721.15:flashCharacter (to do)
    #@+node:ekr.20070213170721.16:getFocus
    def getFocus (self):
    ...
    findFocus = getFocus
    #@-node:ekr.20070213170721.16:getFocus
    #@+node:ekr.20070213170721.17:get
    ...
    #@-node:ekr.20070213170721.17:get
    #@+node:ekr.20070213170721.18:getAllText
    def getAllText (self):
        ...
        return g.toUnicode(s,g.app.tkEncoding)
    #@-node:ekr.20070213170721.18:getAllText
    #@+node:ekr.20070213170721.19:getInsertPoint (baseText)
    def getInsertPoint(self):
        ...
        return i
    #@-node:ekr.20070213170721.19:getInsertPoint (baseText)
    #@+node:ekr.20070213170721.20:getSelectedText
    def getSelectedText (self):
        ...
        return g.toUnicode(s,g.app.tkEncoding)
    #@-node:ekr.20070213170721.20:getSelectedText
    #@+node:ekr.20070213170721.21:getSelectionRange (baseText)
    def getSelectionRange (self,sort=True):
        ...
        if len(sel) == 2 and sel[0] >= 0 and sel[1] >= 0:
            ...
            return i,i
    #@-node:ekr.20070213170721.21:getSelectionRange (baseText)
    #@+node:ekr.20070213170721.22:getYScrollPosition
    def getYScrollPosition (self):
    
         w = self
         return w._getYScrollPosition()
    #@-node:ekr.20070213170721.22:getYScrollPosition
    #@+node:ekr.20070213170721.23:getWidth
    def getWidth (self):
        ...
        return 0
    #@-node:ekr.20070213170721.23:getWidth
    #@+node:ekr.20070213170721.24:hasSelection
    def hasSelection (self):
        ...
        return i != j
    #@-node:ekr.20070213170721.24:hasSelection
    #@+node:ekr.20070213170721.25:insert
    ...
    def replace (self,i,j,s):
        ...
        w.insert(i,s)
    #@-node:ekr.20070213170721.27:replace
    #@+node:ekr.20070213170721.28:scrollLines
    ...
    #@nonl
    #@-node:ekr.20070213170721.28:scrollLines
    #@+node:ekr.20070213170721.29:see & seeInsertPoint
    def see(self,index):
    ...
    def seeInsertPoint(self):
        ...
        w._see(i)
    #@-node:ekr.20070213170721.29:see & seeInsertPoint
    #@+node:ekr.20070213170721.30:selectAllText
    ...
    #@-node:ekr.20070213170721.30:selectAllText
    #@+node:ekr.20070213170721.31:setAllText
    ...
    #@nonl
    #@-node:ekr.20070213170721.31:setAllText
    #@+node:ekr.20070213170721.32:setBackgroundColor & SetBackgroundColour
    ...
    #@nonl
    #@-node:ekr.20070213170721.32:setBackgroundColor & SetBackgroundColour
    #@+node:ekr.20070213170721.33:setFocus
    def setFocus (self):
    ...
    SetFocus = setFocus
    #@-node:ekr.20070213170721.33:setFocus
    #@+node:ekr.20070213170721.34:setInsertPoint (baseText)
    def setInsertPoint (self,pos):
        ...
        w._setInsertPoint(i)
    #@-node:ekr.20070213170721.34:setInsertPoint (baseText)
    #@+node:ekr.20070213170721.35:setSelectionRange (baseText)
    ...
    #@-node:ekr.20070213170721.35:setSelectionRange (baseText)
    #@+node:ekr.20070213170721.36:setWidth
    def setWidth (self,width):
        ...
        pass
    #@-node:ekr.20070213170721.36:setWidth
    #@+node:ekr.20070213170721.37:setYScrollPosition
    ...
    #@nonl
    #@-node:ekr.20070213170721.37:setYScrollPosition
    #@+node:ekr.20070213170721.38:tags (to-do)
    #@+node:ekr.20070213170721.39:mark_set (to be removed)
    ...
    #@-node:ekr.20070213170721.39:mark_set (to be removed)
    #@+node:ekr.20070213170721.40:tag_add
    ...
    #@nonl
    #@-node:ekr.20070213170721.40:tag_add
    #@+node:ekr.20070213170721.41:tag_configure & helper
    ...
    #@nonl
    #@+node:ekr.20070213170721.42:tkColorToWxColor
    ...
    #@-node:ekr.20070213170721.42:tkColorToWxColor
    #@-node:ekr.20070213170721.41:tag_configure & helper
    #@+node:ekr.20070213170721.43:tag_delete (NEW)
    def tag_delete (self,tagName,*args,**keys):
        
        pass # g.trace(tagName,args,keys)
    #@nonl
    #@-node:ekr.20070213170721.43:tag_delete (NEW)
    #@+node:ekr.20070213170721.44:tag_names
    def tag_names (self, *args):
        
        return []
    #@-node:ekr.20070213170721.44:tag_names
    #@+node:ekr.20070213170721.45:tag_ranges
    def tag_ranges(self,tagName):
        ...
        return tuple(aList)
    #@-node:ekr.20070213170721.45:tag_ranges
    #@+node:ekr.20070213170721.46:tag_remove
    ...
    #@nonl
    #@-node:ekr.20070213170721.46:tag_remove
    #@+node:ekr.20070213170721.47:yview
    def yview (self,*args):
    ...
    #@-node:ekr.20070213170721.47:yview
    #@-node:ekr.20070213170721.38:tags (to-do)
    #@+node:ekr.20070213170721.48:xyToGui/PythonIndex
