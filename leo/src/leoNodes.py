...
#@nonl
#@-node:ekr.20070630070045.17:@test p.comparisons
#@+node:ekr.20070630070045.18:@test p.isCurrentPosition
if g.unitTesting:
    n = g.app.positions
...
#@nonl
#@-node:ekr.20070630070045.18:@test p.isCurrentPosition
#@+node:ekr.20070630070045.19:@test p.isRootPosition
if g.unitTesting:
    n = g.app.positions
...
#@nonl
#@-node:ekr.20070630070045.19:@test p.isRootPosition
#@+node:ekr.20070630070045.20:@test that clones share subtrees
if g.unitTesting:
...
#@nonl
#@-node:ekr.20070630070045.20:@test that clones share subtrees
#@+node:ekr.20070630070045.21:@test consistency of c.allNodes_iter() and p.ThreadNext()
if g.unitTesting:
...
#@-node:ekr.20070630070045.21:@test consistency of c.allNodes_iter() and p.ThreadNext()
#@+node:ekr.20070630070045.22:@test consistency of firstChild & children_iter()
if g.unitTesting:
    for copy in (True,False):
        for p in c.allNodes_iter(copy=copy):
        ...
        assert not p2, repr(p2)
#@-node:ekr.20070630070045.22:@test consistency of firstChild & children_iter()
#@+node:ekr.20070630070045.23:@test consistency of level
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.23:@test consistency of level
#@+node:ekr.20070630070045.24:@test consistency of back/next links
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.24:@test consistency of back/next links
#@+node:ekr.20070630070045.25:@test consistency of parent & parents_iter()
if g.unitTesting:
    for copy in (True,False):
...
#@nonl
#@-node:ekr.20070630070045.25:@test consistency of parent & parents_iter()
#@+node:ekr.20070630070045.26:@test consistency of parent/child links
if g.unitTesting:
...
#@-node:ekr.20070630070045.26:@test consistency of parent/child links
#@+node:ekr.20070630070045.27:@test consistency of threadBack/Next links
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@nonl
#@-node:ekr.20070630070045.27:@test consistency of threadBack/Next links
#@+node:ekr.20070630070045.28:@test consistency of tnodeListAndParents
if g.unitTesting:
    for p in c.allNodes_iter():
        if p.isCloned():
...
#@nonl
#@-node:ekr.20070630070045.28:@test consistency of tnodeListAndParents
#@+node:ekr.20070630070045.29:@test hasNextBack
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.29:@test hasNextBack
#@+node:ekr.20070630070045.30:@test hasParentChild
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.30:@test hasParentChild
#@+node:ekr.20070630070045.31:@test hasThreadNextBack
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.31:@test hasThreadNextBack
#@+node:ekr.20070630070045.32:@test vnode list
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@nonl
#@-node:ekr.20070630070045.32:@test vnode list
#@+node:ekr.20070630070045.33:@test isAncestorOf
if g.unitTesting:
    for p in c.allNodes_iter():
...
#@-node:ekr.20070630070045.33:@test isAncestorOf
#@+node:ekr.20070630070045.34:@test onHyperLinkControlClick
if g.unitTesting:
    # This hack is needed only for tkinter gui.
    if g.app.gui.guiName() == 'tkinter':
        p.OnHyperLinkControlClick(event=None)
#@-node:ekr.20070630070045.34:@test onHyperLinkControlClick
#@+node:ekr.20070630070045.35:@test v/t.__hash__
if g.unitTesting:
    import leoNodes
