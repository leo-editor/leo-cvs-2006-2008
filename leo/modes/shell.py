...
# Rules list for shell_main ruleset.
shell_main_rules = [
...
# Rules list for shell_literal ruleset.
shell_literal_rules = [
	rule26, rule27, ]
...
# Rules list for shell_exec ruleset.
shell_exec_rules = [
	rule28, rule29, rule30, rule31, rule32, rule33, rule34, rule35, rule36, rule37,
]

# Rules dict for shell mode.
rulesDict = {
	"shell_exec": shell_exec_rules,
	"shell_literal": shell_literal_rules,
	"shell_main": shell_main_rules,
}
