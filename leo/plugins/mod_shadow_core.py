#@+leo-ver=4-thin
#@+node:bwmulder.20060418142633:@thin mod_shadow_core.py
#@+others
#@+node:bwmulder.20060418151853:import
import difflib
import sys
import os
#@-node:bwmulder.20060418151853:import
#@+node:bwmulder.20060418151953:globals
...
__cvsid__   = "$Id$"
#@-node:bwmulder.20060418151953:globals
#@+node:bwmulder.20060418150747:plugin core
#@+others
#@+node:bwmulder.20060418150747.1:auxilary functions
#@+others
#@+node:bwmulder.20060418150747.2:copy_time
...
#@-node:bwmulder.20060418150747.2:copy_time
#@+node:bwmulder.20060418150747.3:marker_from_extension
def marker_from_extension (filename):
    ...
    return marker 
#@-node:bwmulder.20060418150747.3:marker_from_extension
#@+node:bwmulder.20060418150747.4:write_if_changed
def write_if_changed (lines, sourcefilename, targetfilename):
   ...
   return copy 
#@-node:bwmulder.20060418150747.4:write_if_changed
#@+node:bwmulder.20060418150747.5:is_sentinel
...
#@-node:bwmulder.20060418150747.5:is_sentinel
#@+node:bwmulder.20060418150747.6:class sourcereader
class sourcereader:
    """
    ...
    """
    #@	@+others
    #@+node:bwmulder.20060418150747.7:__init__
    def __init__ (self, lines):
       self.lines = lines 
       self.length = len(self.lines)
       self.i = 0
    #@-node:bwmulder.20060418150747.7:__init__
    #@+node:bwmulder.20060418150747.8:index
    def index (self):
       return self.i 
    #@-node:bwmulder.20060418150747.8:index
    #@+node:bwmulder.20060418150747.9:get
    def get (self):
       result = self.lines[self.i]
       self.i+=1
       return result 
    #@-node:bwmulder.20060418150747.9:get
    #@+node:bwmulder.20060418150747.10:sync
    def sync (self,i):
       self.i = i 
    #@-node:bwmulder.20060418150747.10:sync
    #@+node:bwmulder.20060418150747.11:size
    def size (self):
       return self.length 
    #@-node:bwmulder.20060418150747.11:size
    #@+node:bwmulder.20060418150747.12:atEnd
    def atEnd (self):
       return self.index>=self.length 
    #@-node:bwmulder.20060418150747.12:atEnd
    #@+node:bwmulder.20060418150747.13:clone
    def clone(self):
    ...
    #@nonl
    #@-node:bwmulder.20060418150747.13:clone
    #@+node:bwmulder.20060419103906:dump
    def dump(self, title):
        """
    ...
    #@-others
#@-node:bwmulder.20060418150747.6:class sourcereader
#@+node:bwmulder.20060418150747.14:class sourcewriter
class sourcewriter:
    """
    ...
    """
    #@	@+others
    #@+node:bwmulder.20060418150747.15:__init__
    def __init__ (self):
       self.i = 0
       self.lines =[]
    #@-node:bwmulder.20060418150747.15:__init__
    #@+node:bwmulder.20060418150747.16:put
    def put(self, line):
       self.lines.append(line)
       self.i+=1
    #@-node:bwmulder.20060418150747.16:put
    #@+node:bwmulder.20060418150747.17:index
    def index (self):
       return self.i 
    #@-node:bwmulder.20060418150747.17:index
    #@+node:bwmulder.20060418150747.18:getlines
    def getlines (self):
       return self.lines 
    #@-node:bwmulder.20060418150747.18:getlines
    #@+node:bwmulder.20060419104107:dump
    def dump(self, title):
        """
        Little dump routine for easy debugging
        """
    ...
    #@-others
#@-node:bwmulder.20060418150747.14:class sourcewriter
#@+node:bwmulder.20060418150747.19:copy_file_removing_sentinels
...
#@-node:bwmulder.20060418150747.19:copy_file_removing_sentinels
#@+node:bwmulder.20060418150747.20:read_file_separating_out_sentinels
...
#@-node:bwmulder.20060418150747.20:read_file_separating_out_sentinels
#@+node:bwmulder.20060418150747.21:separate_regular_lines_from_sentinel_lines
...
#@-node:bwmulder.20060418150747.21:separate_regular_lines_from_sentinel_lines
#@+node:bwmulder.20060418150747.22:push_filter_mapping
...
#@nonl
#@-node:bwmulder.20060418150747.1:auxilary functions
#@+node:bwmulder.20060418150747.26:class sentinel_squasher
class sentinel_squasher:
    ...
    """
    #@	@+others
    #@+node:bwmulder.20060418155233:__init__
    def __init__(self, es, nullObject):
        self.es = es
        self.nullObject = nullObject
    #@-node:bwmulder.20060418155233:__init__
    #@+node:bwmulder.20060418150747.27:check_lines_for_equality
    ...
    #@-node:bwmulder.20060418150747.27:check_lines_for_equality
    #@+node:bwmulder.20060418150747.28:create_back_mapping
    ...
    #@-node:bwmulder.20060418150747.28:create_back_mapping
    #@+node:bwmulder.20060418150747.32:check_the_final_output
    ...
    #@-node:bwmulder.20060418150747.32:check_the_final_output
    #@+node:bwmulder.20060418150747.33:propagate_changes_from_file_without_sentinels_to_file_with_sentinels
    ...
    #@-node:bwmulder.20060418150747.33:propagate_changes_from_file_without_sentinels_to_file_with_sentinels
    #@+node:bwmulder.20060423102729:copy_sentinels
    ...
    #@-node:bwmulder.20060423102729:copy_sentinels
    #@+node:bwmulder.20060418150747.34:propagate_changes_from_lines_without_sentinels_to_lines_with_sentinels
    def propagate_changes_from_lines_without_sentinels_to_lines_with_sentinels(self, 
        ...
        """
        #@    <<print_all_func>>
        #@+node:bwmulder.20060419104307:<< print_all_func>>
        ...
        #@    << init vars >>
        #@+node:bwmulder.20060418150747.35:<< init vars >>
        ...
        for tag, i1_old_lines, i2_old_lines, i1_new_lines, i2_new_lines in sm.get_opcodes():
            ...
            if tag=='equal':
                #@            << handle 'equal' op >>
                #@+node:bwmulder.20060418150747.39:<< handle 'equal' op >>
                ...
                #@            << handle 'replace' op >>
                #@+node:bwmulder.20060418150747.40:<< handle 'replace' op >>
                ...
                #@            << handle 'delete' op >>
                #@+node:bwmulder.20060418150747.41:<< handle 'delete' op >>
                ...
                #@            << handle 'insert' op >>
                #@+node:bwmulder.20060418150747.42:<< handle 'insert' op >>
                while reader_new_lines_without_sentinels.index()<i2_new_lines:
                   line = reader_new_lines_without_sentinels.get()
                   writer_new_sourcelines.put(line)
        ...
        #@+node:bwmulder.20060418150747.43:<< final correctness check >>
        if 1:
...
#@nonl
#@-node:bwmulder.20060418150747:plugin core
#@+node:bwmulder.20060418150023:test_propagate_changes
