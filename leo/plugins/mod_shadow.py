#@+leo-ver=4-thin
#@+node:bwmulder.20060418131356.17:@thin mod_shadow.py
# Some unit tests for the core file exist.

#@<<docstring>>
#@+node:bwmulder.20060418131356.18:<< docstring >>
"""
...
__version__ = "0.9"
#@<< version history >>
#@+node:bwmulder.20060418131356.19:<< version history >>
#@@killcolor 
#@+at
# 
...
#@nl
#@<< globals >>
#@+node:bwmulder.20060418131356.20:<< globals >>
...
#@nl
#@<< Notes >>
#@+node:bwmulder.20060418131356.21:<< Notes >>
#@+doc
...
#@+node:bwmulder.20060418131356.22:<< Implementation notes >>
#@+doc
...
#@+others
#@+node:bwmulder.20060418131356.23:imports
...
#@nonl
#@-node:bwmulder.20060418131356.23:imports
#@+node:bwmulder.20060418131356.68:interface
#@+node:bwmulder.20060418131356.69:plugin specific functions
#@+node:bwmulder.20060418131356.70:putInHooks
def putInHooks ():
...
#@-node:bwmulder.20060418131356.70:putInHooks
#@+node:bwmulder.20060418131356.71:applyConfiguration
...
#@-node:bwmulder.20060418131356.71:applyConfiguration
#@+node:bwmulder.20060418131356.72:check_for_shadow_file
...
#@-node:bwmulder.20060418131356.72:check_for_shadow_file
#@-node:bwmulder.20060418131356.69:plugin specific functions
#@+node:bwmulder.20060418131356.73:additional core functions
#@+node:bwmulder.20060418131356.74:openForRead
...
#@nonl
#@-node:bwmulder.20060418131356.74:openForRead
#@+node:bwmulder.20060418131356.75:openForWrite
...
#@-node:bwmulder.20060418131356.75:openForWrite
#@+node:bwmulder.20060418131356.76:gotoLineNumberOpen
...
#@-node:bwmulder.20060418131356.76:gotoLineNumberOpen
#@-node:bwmulder.20060418131356.73:additional core functions
#@+node:bwmulder.20060418131356.77:Leo overwrites
#@+node:bwmulder.20060418131356.78:gotoLineNumber
#@+node:bwmulder.20060418131356.79:applyLineNumberMappingIfAny
...
#@-node:bwmulder.20060418131356.79:applyLineNumberMappingIfAny
#@-node:bwmulder.20060418131356.78:gotoLineNumber
#@+node:bwmulder.20060418131356.80:writing
#@+doc 
...
#@-doc
#@nonl
#@+node:bwmulder.20060418131356.81:atFile.replaceTargetFileIfDifferent
...
#@-node:bwmulder.20060418131356.81:atFile.replaceTargetFileIfDifferent
#@-node:bwmulder.20060418131356.80:writing
#@+node:bwmulder.20060418131356.82:massageComment
...
#@-node:bwmulder.20060418131356.77:Leo overwrites
#@-node:bwmulder.20060418131356.68:interface
#@+node:bwmulder.20060418131356.83:test_support
#@+node:bwmulder.20060418131356.84:test_propagate_changes_Leo
...
#@-node:bwmulder.20060418131356.84:test_propagate_changes_Leo
#@-node:bwmulder.20060418131356.83:test_support
#@+node:bwmulder.20060418131356.86:stop_testing
def stop_testing ():
   global testing 
   testing = False 
#@-node:bwmulder.20060418131356.86:stop_testing
#@+node:bwmulder.20060418131356.87:main
def main():
    pass
try:
    g.app
