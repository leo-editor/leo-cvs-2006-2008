...
if wx:
    ...
    class wxFocusManagerClass(object):
        ...
        def chooseBodyOrOutline(self):
            ...
            self.c.set_focus(g.choose(
                ...
                frame.tree.treeCtrl, frame.bodyCtrl
            ))
        #@nonl
        #@-node:bob.20070901193129.6:chooseBodyOfOutline
        #@-others
    ...
    class wxLeoBody (leoFrame.leoBody):
        ...
        #@nonl
        #@-node:bob.20070813163332.244:wxBody.forceFullRecolor
        #@+node:bob.20070813163332.245:Editors (wxBody) TO DO
        #@+at 
        #@nonl
        # **Important**: body.bodyCtrl and body.frame.bodyCtrl must always be 
        # the same.
        #@-at
        #@+node:bob.20070902173449:TEXT
        #@-node:bob.20070902173449:TEXT
        #@+node:bob.20070813163332.246:recolorWidget
        ...
        #@nonl
        #@-node:bob.20070813163332.246:recolorWidget
        #@+node:bob.20070813163332.247:create/select/unselect/Label
        ...
        #@-node:bob.20070813163332.247:create/select/unselect/Label
        #@+node:bob.20070813163332.248:addEditor
        def addEditor (self,event=None):
            ...
            #@+node:bob.20070813163332.249:<< create label and text widgets >>
            f = Tk.Frame(pane)
            ...
            c.bodyWantsFocusNow()
        #@-node:bob.20070813163332.248:addEditor
        #@+node:bob.20070813163332.250:setEditorColors
        def setEditorColors (self,bg,fg):
            ...
            for key in d.keys():
                ...
                try:
                    ...
                    pass
        #@-node:bob.20070813163332.250:setEditorColors
        #@+node:bob.20070813163332.251:cycleEditorFocus
        def cycleEditorFocus (self,event=None):
            ...
            return 'break'
        #@-node:bob.20070813163332.251:cycleEditorFocus
        #@+node:bob.20070813163332.252:deleteEditor
        def deleteEditor (self,event=None):
            ...
            self.selectEditor(w)
        #@-node:bob.20070813163332.252:deleteEditor
        #@+node:bob.20070813163332.253:selectEditor (tkBody)
        def selectEditor(self,w):
            ...
            #@+node:bob.20070813163332.254:<< restore the selection, insertion point and the scrollbar >>
        ...
        #@nonl
        #@-node:bob.20070813163332.253:selectEditor (tkBody)
        #@+node:bob.20070813163332.255:selectMainEditor
        ...
        #@-node:bob.20070813163332.255:selectMainEditor
        #@+node:bob.20070813163332.256:updateEditors
